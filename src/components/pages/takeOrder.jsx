...
const TakeOrder = () => {
    ...
    return ( <
        ...
        <
        button className = 'flex items-center p-2 h-5 hover:bg-gray-300 transition'
        onClick = {
            () => { setCountProduct((prev) => prev - 1) } } > < p > - < /p></button >
        <
        p min = "1"
        className = 'p-2' > { countProduct <= 0 ? setCountProduct(1) : countProduct } < /p> <
        button className = 'flex items-center p-2 h-5 hover:bg-gray-300 transition'
        onClick = {
            () => { setCountProduct((prev) => prev + 1) } } > < p > + < /p></button >
        <
        ...
        input className = 'bg-gray-300 m-1'
        type = "text"
        onChange = {
        ...
        <
        /div> <
        button className = 'bg-green-400 p-2 w-[30%] text-white hover:bg-green-700 transition'
        onClick = {
            (e) => makeOrder(e) } > Make order < /button> <
        /div> <
        /div> <
        /div> <
        /main> <
