...
const ProductPage = () => {
    ...
    return ( <
        ...
        <
        img className = 'w-[300px] m-5 border border-gray-400 rounded-lg p-5'
        src = { `${apiRequest}/uploads/products/${productInfo?.image}` }
        alt = "Product_photo" / >
        <
        ...
        <
        Link className = 'bg-green-400 p-2 w-[30%] text-white text-center hover:bg-green-700 transition'
        to = { `../takeOrder/${productInfo?.id}` } > Buy < /Link> <
        /div> <
        ...
        /div> <
        /div> <
        button className = 'w-10 h-10 bg-red-400 m-3 text-[20px] text-white hover:bg-red-700 hover:text-white transition'
        onClick = {
            () => {
        ...
        div className = "feedbacks mt-5" > {
            replyState ? ( <
                ...
                className = "px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600" > Reply < /button> <
                />
            ) : ( <
                ...
                className = "px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600" > Submit < /button> <
                /div>
            )
        } <
        /div> <
