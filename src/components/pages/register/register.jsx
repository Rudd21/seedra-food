...
const addProduct = (e) => {
    ...
    return ( <
        ...
        className = 'form lg:border lg:border-gray-300 lg:border-t-0 lg:border-b-0 m-5' >
        <
        ...
        button className = 'bg-[#eaf1eb] cursor-pointer hover:bg-[#67AE6E] transition duration-300'
